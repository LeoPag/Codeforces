...
void solve(){
    ...
    ll dist_a_major = 100000000000;
    ll dist_b_major = 100000000000;


    f(1,i,k+1){


        if(abs(cities[i].first - cities[a].first) + abs(cities[i].second - cities[a].second) < dist_a_major){
            dist_a_major = abs(cities[i].first - cities[a].first) + abs(cities[i].second - cities[a].second);
        }

         if(abs(cities[i].first - cities[b].first) + abs(cities[i].second - cities[b].second) < dist_b_major){
            dist_b_major = abs(cities[i].first - cities[b].first) + abs(cities[i].second - cities[b].second);
        }
    ...
    cout << min(direct, dist_a_major + dist_b_major) << endl;
