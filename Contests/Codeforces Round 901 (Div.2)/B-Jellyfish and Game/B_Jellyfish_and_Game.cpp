...
void solve(){
    ...
    if(k%2 == 1){
        if(max_b > min_a) ans = ans - min_a + max_b;
    }
    else{
        if(max_b > min_a) ans = ans - min_a + max_b;

        if(max_b > max_a){
            if(min_a < min_b) ans = ans - max_b + min_a;
            else ans = ans - max_b + min_b;
        } 
        else {
            if(min_a < min_b) ans = ans - max_a + min_a;
            else ans = ans - max_a + min_b;
        }
